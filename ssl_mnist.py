...
model_list = [gl.ssl.laplace(W),
              ...
              gl.ssl.peikonal(W, D=D, p=1, alpha=4, class_priors=gl.utils.class_priors(labels)),
              ...
              gl.ssl.graph_nearest_neighbor(W, D=D, alpha=4, class_priors=gl.utils.class_priors(labels)),
              gl.ssl.graph_nearest_neighbor(W, D=D, alpha=5, class_priors=gl.utils.class_priors(labels)),
              gl.ssl.graph_nearest_neighbor(W, D=D, alpha=6, class_priors=gl.utils.class_priors(labels)),
              gl.ssl.graph_nearest_neighbor(W, D=D, alpha=7, class_priors=gl.utils.class_priors(labels))]
